...
from VoiceAssistant.nlu_stable.client import Client
from VoiceAssistant.nlu_stable.client_config import *
from VoiceAssistant.nlu_stable.taskmanager import TaskManager
...
#=============================================================================================================
						...
						if '--weather' == self.intent:
							...
							# keep reciting the news in another process
							news_loop = multiprocessing.Process(target=loop_speech, args=(news_list))
							news_loop.start()
							# continue to listen for stop word. if found, terminate the previous process
