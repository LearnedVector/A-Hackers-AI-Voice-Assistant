...
Looking for contributors to help build out the assistant. There is still alot of work to do. This would be a good opportunity to learn Machine Learning and how to Engineer an entire ML system from the ground up. If you're interested join the [Discord Server](https://discord.gg/9wSTT4F)
...
- [ ] skills framework
- [ ] Core A.I. Voice Assistant logic to integrate wake word, speech recognition, natural language understanding, speech sysnthesis, and the skills framework.
